...
**Personal Skills** (`C:\Users\mifta\.gemini\antigravity\skills\`):
...
```bash
# Personal
mkdir -p C:\Users\mifta\.gemini\antigravity\skills\skill-name
...
3. **Verify activation**: Antigravity should use the Skill automatically

4. **Check behavior**: Confirm Antigravity follows the instructions correctly

### Step 10: Debug if needed

If Antigravity doesn't use the Skill:
...
2. **Check file location**:
   ```bash
   ls C:\Users\mifta\.gemini\antigravity\skills\skill-name\SKILL.md
