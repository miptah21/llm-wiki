...
def audit_geo(target_dir):
    ...
    for root, dirs, files in os.walk(target_dir):
        ...
        for file in files:
            ...
            if "lang=" in content:
                passes.append(f"{rel_path} declares HTML lang attribute.")
            else:
                warnings.append(f"[{rel_path}] Missing 'lang' attribute on <html> tag.")
                
    print(f"## Script Results: geo_checker.py")
